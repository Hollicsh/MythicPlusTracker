...
local locale = {
    ...
    ["COMBAT_LOCKDOWN_WARNING"] = "La fenêtre du suivi ne peut pas être ouverte en combat.",
    ...
    ["KEYSTONES_REFRESH_TITLE"] = "Actualiser",
    ["KEYSTONES_MODE_GROUP"]  = "Groupe",
    ["KEYSTONES_MODE_ALTS"]   = "Alts",
    ["KEYSTONES_ALTS_EMPTY"]  = "Aucun alt enregistré pour le moment.",
    ["KEYSTONES_MODE_GUILD"]  = "Guilde",
    ["KEYSTONES_GUILD_EMPTY"] = "Aucun membre de guilde connu pour le moment.",
    ["KEYSTONES_LAST_UPDATED"] = "Dernière mise à jour : %s",
    ...
    ["KEYSTONES_EXTERNAL_SOURCE"] = "* Données provenant d'un autre addon (LibKeystone)",
