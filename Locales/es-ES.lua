...
local locale = {
    ...
    ["COMBAT_LOCKDOWN_WARNING"] = "La ventana del rastreador no se puede abrir durante el combate.",
    ...
    ["SIDEBAR_STATS_BEST"]      = "Key más alto:",
    ...
    ["KEYSTONES_REFRESH_TITLE"] = "Actualizar",
    ...
    ["KEYSTONES_LAST_UPDATED"] = "Última actualización: %s",
    ...
    ["KEYSTONES_EXTERNAL_SOURCE"] = "* Datos de otro addon (LibKeystone)",
