...
- **Click a dungeon name to open the Adventure Guide there.** Works in the Keystones, Overview and Runs tabs and on the sidebar's best run. The icon keeps teleporting you.
